...
export interface AdminPortalService {
  // 获取登录验证码
  GetCaptcha(request: wellKnownEmpty): Promise<GetCaptchaResponse>;
  // 查询前端路由表
...
export function createAdminPortalServiceClient(
  ...
  return {
    GetCaptcha(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
